...
const result = document.querySelector("#degree1");
const inputTemperatureUnit = document.querySelector("#inputtype");
const resultTemperatureUnit = document.querySelector("#resulttype");
...
temperature.oninput = function () {
  ...
  let CelsiusToKelvin =
    inputTemperatureUnitValue === "Celsius" &&
    resultTemperatureUnitValue === "Kelvin";
  let CelsiusToFahrenheit =
    inputTemperatureUnitValue === "Celsius" &&
    resultTemperatureUnitValue === "Fahrenheit";
  let KelvinToCelsius =
    inputTemperatureUnitValue === "Kelvin" &&
    resultTemperatureUnitValue === "Celsius";
  let KelvinToFahrenheit =
    inputTemperatureUnitValue === "Kelvin" &&
    resultTemperatureUnitValue === "Fahrenheit";
  let FahrenheitToCelsius =
    inputTemperatureUnitValue === "Fahrenheit" &&
    resultTemperatureUnitValue === "Celsius";
